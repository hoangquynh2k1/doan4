...
@section('content')
        ...
        <div class="container-fluid px-4">
            ...
            <div class="card-body">
                <table id="datatablesSimple" class="table table-bordered table-hover">
                    ...
                    <tbody>
                        <tr dir-paginate="lsp in loai_sp |filter: timkiem |itemsPerPage: pageSize">
                            <td>@{{ $index + 1 }}</td>
                            <td>@{{ lsp.tenloai }}</td>
                            <td>@{{ lsp.mota }}</td>
                            <td><button class="btn btn-info fa fa-pencil" ng-click="showmodal(lsp.id)"></button></td>
    ...
    <script src="/admins/js/loaispcontroller.js"></script>
